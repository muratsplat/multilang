...
| multilang.crud.updating     |`Muratsplat\Multilag\MultiLang` Object | When models is updating, this event is fired.          |
| multilang.crud.deleting     |`Muratsplat\Multilag\MultiLang` Object | When models is deleting, this event is fired.          |
