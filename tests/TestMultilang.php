    ...
    private $multilangPost = array(
        ...
        */
        ...
        public function testEventControlOnMultilang() {
            ...
            $this->app->singleton('multilang', function($app) use ($mockedConfig, $messageBag, $validator, $wrapper) {
            ...
            $this->app['events']->listen('multilang.wantedlang', 'Muratsplat\Multilang\Events\WantedLangEvent');
            $this->app['events']->fire('multilang.wantedlang', 3 );
            ...
            /* setting wanted lang id by firing event */
            $this->app['events']->fire('multilang.wantedlang', 1 );            
            $wrapper1 = $this->app['multilang']->makeWrapper($content);            
            $this->assertEquals($postFirst['title'], $wrapper1->title );
            
            /* setting wanted lang id by firing event */
            $this->app['events']->fire('multilang.wantedlang', 2 );            
